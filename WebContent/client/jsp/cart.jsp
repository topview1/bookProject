...
<div class="infocontent">
			...
			<tr>
				...
				<th width="20%">
					...
					<input type="button" value='-' style="width:20px"
							onclick="changeProductNum('${cart.value-1}','${cart.key.pnum}','${cart.key.id}')">
					<!-- 商品数量显示 -->
				...
				<th width="10%"><input type="button" value='取消' style="width:30px"
							onclick="changeProductNum('0','${cart.key.pnum}','${cart.key.id}')">
				</th>
			</tr>
	...
	<div class="option">
		...
		<a class="button" style="float: right" href="${pageContext.request.contextPath}/client/jsp/order.jsp">结账</a>
	</div>
</div>
